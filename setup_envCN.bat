@echo off
echo ========================================
echo PhantomVox Environment Setup (System VEnv - CN Mirror)
echo ========================================
echo.
...
echo [3.5/4] Installing qwen-tts from Gitee...
python -m pip install git+https://gitee.com/lingyesoul/Qwen3-TTS-Streaming
